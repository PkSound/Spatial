...
namespace MathNet.Spatial.Euclidean
{
  ...
  public struct Plane : IEquatable<Plane>
  {
    ...
    public Plane(double a, double b, double c, double d) : this(new UnitVector3D(a, b, c), -1*d) { }
    ...
    public Plane(UnitVector3D normal, Point3D rootPoint) : this(rootPoint, normal) { }
    ...
    public double A { get { return this.Normal.X; } }

    public double B { get { return this.Normal.Y; } }

    public double C { get { return this.Normal.Z; } }
    ...
    {
      return string.Format("A:{0} B:{1} C:{2} D:{3}", Math.Round(this.A, 4), Math.Round(this.B, 4),
                           Math.Round(this.C, 4), Math.Round(this.D, 4));
    }
  }
}
